...
import { ONE_YEAR_SECONDS, cookieStore } from "./cookie.js";
import { guard, localStore, memoryStore, nullStore, probe } from "./stores.js";
...
function hostMatchesDomain(domain) {
...
export function createStorage(config = {}) {
  ...
  const withPrefix = (key) => `${resolved.keyPrefix}${key}`;
  return {
