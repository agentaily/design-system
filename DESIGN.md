...
| **L4 Page shells / frames** | full-page layout with slots | L1–L3 | `AppShell`, `DesignerShell`, `DocsLayout`, `SignInPage`, `PanelSheet` (floating shell) → `SettingsSheet` (settings page on it) |
